    ...
    <footer className="mt-24 bg-secondary text-secondary-foreground">
      <div className="mx-auto grid max-w-7xl gap-12 px-5 py-16 md:grid-cols-[1.3fr_1fr_1fr] md:px-8">
        <div className="flex flex-col gap-4">
          ...
          <p className="max-w-sm text-sm leading-relaxed text-secondary-foreground/70">讓校園裡每一種微小的聲音，都有被閱讀的可能。這是屬於學生的文薈
          。</p>
        </div>
      ...
      <div className="border-t border-secondary-foreground/15 px-5 py-5 text-center text-xs tracking-wider text-secondary-foreground/50">© 2026 東山文薈</div>
    </footer>
  )
}
